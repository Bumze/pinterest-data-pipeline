...
#example_df = {"index": 1, "name": "Maya", "age": 25, "role": "engineer"}
            ...
            invoke_url2 = "https://kd1wwg7hnj.execute-api.us-east-1.amazonaws.com/0e35b2767ae1Pinterest/topics/0e35b2767ae1.geo"
            payload2 = json.dumps({
            "records": [
                    {
            ...
            invoke_url3 = "https://kd1wwg7hnj.execute-api.us-east-1.amazonaws.com/0e35b2767ae1Pinterest/topics/0e35b2767ae1.user"
            payload3 = json.dumps({
            "records": [
                    {
